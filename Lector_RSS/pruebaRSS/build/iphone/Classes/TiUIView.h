...
/**
 Base class for all pruebaRSS views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the pruebaRSS view hierarchy (such as wrapped iOS UIViews) was touched.

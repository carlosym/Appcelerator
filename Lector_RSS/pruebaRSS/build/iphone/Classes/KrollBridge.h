...
@interface pruebaRSSObject : KrollCoverageObject {
#else
@interface pruebaRSSObject : KrollObject {
#endif
@private
...
extern NSString * pruebaRSS$ModuleRequireFormat;

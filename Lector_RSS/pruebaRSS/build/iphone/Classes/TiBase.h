...
// in simulator we redefine to format for pruebaRSS Developer console
...
{\
	NSString * exceptionName = [@"org.pruebarss." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.pruebarss";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIpruebaRSSNativeItemNone = -1, 
	UIpruebaRSSNativeItemSpinner = -2,
	UIpruebaRSSNativeItemProgressBar = -3,
	
	UIpruebaRSSNativeItemSlider = -4,
	UIpruebaRSSNativeItemSwitch = -5,
	UIpruebaRSSNativeItemMultiButton = -6,
	UIpruebaRSSNativeItemSegmented = -7,
	
	UIpruebaRSSNativeItemTextView = -8,
	UIpruebaRSSNativeItemTextField = -9,
	UIpruebaRSSNativeItemSearchBar = -10,
	
	UIpruebaRSSNativeItemPicker = -11,
	UIpruebaRSSNativeItemDatePicker = -12,
	
	UIpruebaRSSNativeItemInfoLight = -13,
	UIpruebaRSSNativeItemInfoDark = -14,
	
	UIpruebaRSSNativeItemDisclosure = -15,
	
	UIpruebaRSSNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all pruebaRSS instances of

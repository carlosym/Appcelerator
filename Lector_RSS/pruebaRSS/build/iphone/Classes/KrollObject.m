 ...
 * Copyright (c) 2009-2011 by pruebaRSS, Inc. All Rights Reserved.
...
//@interface pruebaRSSObject : NSObject
//@end

@interface pruebaRSSObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[pruebaRSSObject class]])
		{
			for (NSString *key in [[(pruebaRSSObject*)o modules] allKeys])
			{
